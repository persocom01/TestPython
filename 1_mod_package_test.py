...
# Note that using this method imports the functions directly into the symbol table.
from mymodule2 import *
# Imports a package with subpackages and modules defined in __init__.py.
import mypackage as p
# If the modules are not defined, a from packagename import modulename is required instead.
from mypackage import mod1
from mypackage.childpackage import mod2

# Demonstrates progamatic creation of variables. In this case mymodule1 and 2 are imported.
_g = globals()
for i in range(1, 3):
