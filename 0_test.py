...
adler32 = timeit.Timer(
    ...
    setup="import zlib; data=open('file3.txt','rb').read() * 10",
)
...
adler32_running = timeit.Timer(
    ...
    setup="import zlib; data=open('file3.txt','rb').read() * 10; cksum = zlib.adler32(data)",
)
...
crc32_running = timeit.Timer(
    ...
    setup="import zlib; data=open('file3.txt','rb').read() * 10; cksum = zlib.crc32(data)",
)
